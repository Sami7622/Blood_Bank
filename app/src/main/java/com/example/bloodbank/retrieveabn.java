...
public class retrieveabn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieveabn);
        name = findViewById(R.id.nameabn);
        number = findViewById(R.id.numberabn);
        gender = findViewById(R.id.genderabn);
        bloodgroup = findViewById(R.id.bloodgroupabn);
        age = findViewById(R.id.ageabn);

        db.collection("donorsfresh")
                .whereEqualTo("d_bloodgroup", "ab-")
                .get()
