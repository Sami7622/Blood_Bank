...
public class retrieveabp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieveabp);
        name = findViewById(R.id.nameabp);
        number = findViewById(R.id.numberabp);
        gender = findViewById(R.id.genderabp);
        bloodgroup = findViewById(R.id.bloodgroupabp);
        age = findViewById(R.id.ageabp);
