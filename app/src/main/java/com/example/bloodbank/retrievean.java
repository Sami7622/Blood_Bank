...
public class retrievean extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrievean);


        name = findViewById(R.id.tvnamean);
        number = findViewById(R.id.tvnumberan);
        gender = findViewById(R.id.tvgenderan);
        bloodgroup = findViewById(R.id.tvbloodgroupan);
        age = findViewById(R.id.tvagean);
