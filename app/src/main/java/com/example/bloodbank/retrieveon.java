...
public class retrieveon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieveon);name = findViewById(R.id.nameon);
        number = findViewById(R.id.numberon);
        gender = findViewById(R.id.genderon);
        bloodgroup = findViewById(R.id.bloodgroupon);
        age = findViewById(R.id.ageon);
